...
/* Isolate stacking context so sticky elements stay trapped inside main app view */
#mainAppSection, #viewGrading, #gradingSection, .overflow-x-auto {
    isolation: isolate;
}
...
#printPreviewModal .sticky-col-1,
#printPreviewModal .sticky-col-2,
#printPreviewModal .sticky-col-3,
#printPreviewModal thead th,
#printArea .sticky-col-1,
#printArea .sticky-col-2,
#printArea .sticky-col-3,
#printArea thead th {
...
/* Reset sticky positioning for print modal preview and browser printing */
@media print {
    body * {
    ...
    .sticky-col-1, .sticky-col-2, .sticky-col-3, thead th {
        position: static !important;
        box-shadow: none !important;
        z-index: auto !important;
    }
...
<img src="logo.png" alt="ตราโรงเรียนมกุฎเมืองราชวิทยาลัย" class="w-full h-full object-cover rounded-full">
</div>
...
<input type="text" id="teacherId" onkeypress="if(event.key==='Enter') document.getElementById('teacherPin').focus()" class="block w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none" placeholder="เช่น 1509900...">
</div>
<div>
...
<table id="mainTable" class="w-full text-left min-w-[1200px]">
<thead id="tableHeader" class="bg-gray-50 shadow-sm"></thead>
...
<div class="flex-grow text-right flex justify-end gap-2">
<button id="printMatrixBtn" onclick="printMatrixReport()" class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition hidden inline-flex items-center gap-2 shadow-md">
<i class="fa-solid fa-print"></i> พิมพ์รายงาน (Print)
</button>
...
<div id="myRemedialModal" class="fixed inset-0 bg-gray-900 bg-opacity-50 z-[99999] hidden flex items-center justify-center p-4 transition-opacity">
...
<div id="printPreviewModal" class="fixed inset-0 bg-gray-900 bg-opacity-60 z-[99999] hidden flex items-center justify-center p-2 sm:p-4 transition-opacity overflow-y-auto">
    <div class="bg-white rounded-2xl w-full max-w-5xl max-h-[90vh] my-auto shadow-2xl flex flex-col fade-in overflow-hidden">
        ...
        <div class="p-2 sm:p-4 overflow-y-auto flex-grow min-h-0 table-scrollbar bg-gray-100 flex justify-center">
            <div id="printArea" class="bg-white p-3 sm:p-5 shadow-md w-full max-w-[210mm] text-gray-800 box-border rounded-sm" style="font-family: 'Sarabun', sans-serif;">
...
<div id="forceChangePasswordModal" class="fixed inset-0 bg-gray-900 bg-opacity-70 z-[99999] hidden items-center justify-center p-4">
...
<div id="logoutModal" class="fixed inset-0 bg-gray-900 bg-opacity-50 z-[99999] hidden flex items-center justify-center transition-opacity">
